            ...
            >
              <div className="relative aspect-[4/3] rounded-lg overflow-hidden mb-4 cursor-zoom-in group/img">
                ...
                <div className="absolute inset-0 bg-black/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-start justify-end p-3 gap-2">
                  <button
                    className="w-8 h-8 rounded-full bg-white text-[#1a1c1c] shadow-md flex items-center justify-center hover:bg-[#0066cc] hover:text-white transition-colors"
                    aria-label="Edit product"
                  >
                    <Edit2 className="w-4 h-4" />
                  </button>
                  <button
                    className="w-8 h-8 rounded-full bg-white text-[#ba1a1a] shadow-md flex items-center justify-center hover:bg-[#ba1a1a] hover:text-white transition-colors"
